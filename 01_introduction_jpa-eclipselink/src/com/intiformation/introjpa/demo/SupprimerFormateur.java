...
public class SupprimerFormateur {
	public static void main(String[] args) {
		...
		Formateur formateurSupp = em.find(Formateur.class, 1);
		// 4.2 modif du formateur
		if (formateurSupp != null) {

		

			em.remove(formateurSupp); //si on vt supprimer ici on écrit em.remove()
